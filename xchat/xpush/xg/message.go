...
// AndroidMessage android message struct.
...
// AcceptTime notify push time period.
...
// ActivityAttr android activity attribute.
...
// Browser url：打开的url，confirm是否需要用户确认
type Browser struct {
	URL     string `json:"url"`
	Confirm byte   `json:"confirm"`
}

// Package android package struct.
type Package struct {
